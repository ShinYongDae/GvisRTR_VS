...
public:
	...
	static UINT ThreadProc39(LPVOID lpContext); // LoadPcrUpOnOffline()
	static UINT ThreadProc40(LPVOID lpContext); // LoadPcrUpAllOnOffline()
	static UINT ThreadProc41(LPVOID lpContext); // LoadPcrDnOnOffline()
	static UINT ThreadProc42(LPVOID lpContext); // LoadPcrDnAllOnOffline()

	static UINT ThreadProc43(LPVOID lpContext); // m_pReelMapUp->WriteOnOffline()
	static UINT ThreadProc44(LPVOID lpContext); // m_pReelMapDn->WriteOnOffline()
	static UINT ThreadProc45(LPVOID lpContext); // m_pReelMapAllUp->WriteOnOffline()
	static UINT ThreadProc46(LPVOID lpContext); // m_pReelMapAllDn->WriteOnOffline()
